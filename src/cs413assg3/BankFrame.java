...
public class BankFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setActionCommand("Save Customer");
        jButton1.setLabel("Save Customer");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Bank cust = new Bank(name, email);
        cust.setDepartment(dept);
        cust.setPhone(phone);
        int createResult = BankDTO.performCreate(cust);
        if(createResult != -1) {
